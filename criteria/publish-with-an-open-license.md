...
---
# Publish with an open license [![This criterion in the Standard for Public Code]({{site.url}}/assets/link-symbol.png)](https://standard.publiccode.net/criteria/publish-with-an-open-license.html)
