...
---
# Publish with an open license [![This criterion in the Standard for Public Code](../assets/link-symbol.png)](https://www.standardforpubliccode.org/criteria/publish-with-an-open-license.html)
