...
# if PAGES_REPO_NWO is not set then default to
# publiccodenet/community-implementation-guide-standard
...
export PAGES_REPO_NWO=publiccodenet/community-implementation-guide-standard
fi
